...
function analyzePattern(lastTwo, originalTwo = null, extremeCondition = null) {
  ...
  if (realCandidates.length === 0) {
    ...
    return {
      ...
      ifG: { ...fbWinner.projections.ifG, pat: fbWinner.context + 'G', originalConf: fbWinner.projections.ifG.conf },
      ifR: { ...fbWinner.projections.ifR, pat: fbWinner.context + 'R', originalConf: fbWinner.projections.ifR.conf }
    };
  }
